view: top_restaurants_ranking {###View being used for ranking purpose for Top Restaurants module
  derived_table: {
    explore_source: top_restaurants {
      ...
      column: vendor_name {}
      column: total_orders {}
      derived_column: rank { sql: row_number() over (order by total_orders desc);;}
      bind_all_filters: yes
      sort: { field: total_orders desc: yes}
    }
  }
